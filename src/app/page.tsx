...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Per i Privati Section */}
      <section id="privati" className="py-24 bg-gradient-to-br from-amber-50 via-white to-blue-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Risparmia sulla bolletta<br />di casa tua
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Scopri se il tuo fornitore ti sta facendo pagare troppo e trova l&apos;offerta migliore per te
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <h3 className="font-bold text-lg text-gray-900 mb-2">Verifica Errori</h3>
              <p className="text-gray-600 text-sm">
                Identifichiamo errori di fatturazione, letture sbagliate e voci anomale.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <h3 className="font-bold text-lg text-gray-900 mb-2">Confronto Offerte</h3>
              <p className="text-gray-600 text-sm">
                Confrontiamo la tua tariffa con le migliori offerte sul mercato libero.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <h3 className="font-bold text-lg text-gray-900 mb-2">Stima Risparmio</h3>
              <p className="text-gray-600 text-sm">
                Calcoliamo quanto potresti risparmiare cambiando fornitore o tariffa.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <h3 className="font-bold text-lg text-gray-900 mb-2">Tutela Consumatore</h3>
              <p className="text-gray-600 text-sm">
                Supporto per reclami ARERA e tutela dei tuoi diritti di consumatore.
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            <a
              href="#"
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-white font-semibold rounded-xl hover:from-amber-600 hover:to-amber-700 transition-all shadow-lg shadow-amber-500/25"
            >
              Analizza la tua bolletta gratis
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
